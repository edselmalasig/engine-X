...
Camera::Camera(int fbWidth, int fbHeight){
     ...
     this->window_w = fbWidth;
     this->window_h = fbHeight;
...
Camera::Camera(glm::vec3 position, //viewDirection
     ...
     Camera::Camera(GLfloat posX, GLfloat posY, GLfloat posZ,
          ...
          void Camera::computeMatricesFromInputs(){
               ...
               ProjectionMatrix = glm::perspective(glm::radians(*this->Zoom), (float)window_w / (float)window_h, 0.100f, 100.0f);
          }
