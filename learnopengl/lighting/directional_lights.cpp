...
int main(int, char**)
{
     ...
     g_cube->shader = new Shader("./resources/shaders/directional_light.vs", "./resources/shaders/directional_light.fs");
     g_cube->enableShader();
     g_cube->initCubeWNTC();
     ...
     while (!glfwWindowShouldClose(engineX->window))
     {
          ...
          g_cube->enableShader();
          g_cube->shader->setVec3("light.direction", -2.0f, -1.0f, -0.3f);
